      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        ...
        <div className="p-10 grid place-content-center  text-end w-full">
          ...
          <input
            ...
            required
             onChange={getFile}
             className="w-96 h-full lg:w-max-screen lg:h-[105px] border border-black text-black rounded-lg shadow-lg p-2"
          />
        ...
        <div className="p-10 grid place-content-center w-full">
          ...
          <input
            ...
            className="w-96 h-full lg:w-max-screen lg:h-[35px] border border-black text-black rounded-lg shadow-lg p-2"
          />
        </div>
        ...
        <div className="p-10 grid place-content-center w-full">
          ...
          <input
            ...
            className="w-96 h-full lg:w-max-screen lg:h-[35px] border  text-black border-black rounded-lg shadow-lg p-2"
          />
        </div>
        ...
        <div className="p-10  grid place-content-center w-full">
          ...
          <textarea
            className="w-96 h-[300px] lg:w-max-screen lg:h-[400px] border border-black text-black rounded-lg shadow-lg lg:p-10"
            required
            value={body}
        ...
        <div className="p-10  grid place-content-center w-full">
          ...
          <input
            className="w-full h-full lg:w-max-screen lg:h-[35px] border border-black text-black rounded-lg shadow-lg p-2"
            required
            type="number"
            value={id}
