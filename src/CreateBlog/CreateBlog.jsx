      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        ...
        <div className="p-10 grid place-content-center w-full">
          ...
          <input
            ...
            className="w-full h-full lg:w-[500px] lg:h-[35px] border  text-black border-black rounded-lg shadow-lg p-2"
          />
        </div>
        ...
        <div className="p-10  grid place-content-center w-full">
          ...
          <textarea
            className="w-full h-full lg:w-[500px] lg:h-[400px] border border-black text-black rounded-lg shadow-lg p-10"
            required
            value={body}
